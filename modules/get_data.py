...
parse = argparse.ArgumentParser(description='Download and extract data from the given url')

parse.add_argument('--data_path', type=str, default='dataset', help='Path to store the dataset')
parse.add_argument('--url', type=str, default=None, required=True, help='URL of the dataset')

args = parse.parse_args()

DATA_PATH = Path(f'{args.data_path}/')
URL = args.url
